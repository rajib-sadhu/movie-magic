    ...
    return (
        <>
            <div className="h-[35rem] relative" >
                ...
                <section className="md:w-3/4 w-11/12 md:h-60 h-24 bg-white text-black md:border-b-8 border-b-2 border-[#50DBB4] absolute left-1/2 -translate-x-1/2 md:bottom-14" >
                    <div className="h-full w-full md:px-20 px-5 flex justify-between items-start" >
                       
                        <div className="flex items-end md:gap-4 gap-1" >
                            <div className="bg-[#50dbb487] p-2 md:h-48 h-20 md:w-24 w-14 flex items-end" >
                                <BiMedal className="md:text-8xl text-3xl mx-auto text-[#227745]" />
                            </div>
                            <div>
                                <h1 className="md:text-7xl text-2xl font-bold" >23</h1>
                        ...
                        <div className="flex items-end md:gap-4 gap-1" >
                            ...
                            <div>
                                <h1 className="md:text-7xl text-2xl font-bold" >30</h1>
                        ...
                        <div className="flex items-end md:gap-4 gap-1" >
                            ...
                            <div>
                                <h1 className="md:text-7xl text-2xl font-bold" >980</h1>
